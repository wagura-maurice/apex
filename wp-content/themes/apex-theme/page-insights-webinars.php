        ...
        <div class="apex-webinars-upcoming__grid">
            ...
            <div class="apex-webinars-upcoming__item apex-webinars-upcoming__item--featured">
                ...
                <div class="apex-webinars-upcoming__item-content">
                    ...
                    <?php endif; ?>
                    <a href="<?php echo esc_url($event_registration_url ?: '#'); ?>" class="apex-webinars-upcoming__item-cta" target="_blank" rel="noopener noreferrer">Register Now - Free</a>
                </div>
            </div>
            <?php endif; ?>
            ...
            <div class="apex-webinars-upcoming__item">
                ...
                <div class="apex-webinars-upcoming__item-content">
                    ...
                    <a href="<?php echo esc_url($event_registration_url ?: '#'); ?>" class="apex-webinars-upcoming__item-cta apex-webinars-upcoming__item-cta--secondary" target="_blank" rel="noopener noreferrer">Register</a>
                </div>
            </div>
            <?php
                endforeach;
...
apex_render_newsletter_section([
    'form_id'     => 'webinars-newsletter-form',
    'heading'     => get_option('apex_webinars_newsletter_heading_insights-webinars', 'Never Miss an Event'),
    'description' => get_option('apex_webinars_newsletter_description_insights-webinars', 'Subscribe to get notified about upcoming webinars, workshops, and events.'),
    'placeholder' => get_option('apex_webinars_newsletter_placeholder_insights-webinars', 'Enter your email address'),
    'button_text' => get_option('apex_webinars_newsletter_button_insights-webinars', 'Subscribe'),
    'note'        => get_option('apex_webinars_newsletter_note_insights-webinars', 'We respect your privacy. Unsubscribe at any time.'),
    'source'      => 'Apex Website Webinars Newsletter Form',
