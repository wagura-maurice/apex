<?php
/**
 * Template Name: Single News Item
 * Single News Item Template for apex_news CPT
 *
 * @package ApexTheme
 */
...
<?php while (have_posts()) : the_post();
    ...
    $category  = ($terms && !is_wp_error($terms)) ? $terms[0]->name : 'News';
    $cat_slug  = ($terms && !is_wp_error($terms)) ? $terms[0]->slug : 'news';
...
<section class="sn-hero<?php echo $thumb_url ? '' : ' sn-hero--no-img'; ?>"
    ...
    <div class="sn-hero__inner">
        <nav class="sn-hero__breadcrumb">
            ...
            <a href="<?php echo esc_url(home_url('/about-us/news')); ?>">News</a>
        </nav>
    ...
    <div class="sn-body__wrap">
        ...
        <aside class="sn-body__side">
            <div class="sn-side-card">
                <h3 class="sn-side-card__heading">Related News</h3>
                <?php
                $related_args = [
                    'post_type'      => 'apex_news',
                    'post_status'    => 'publish',
                ...
                if ($related_query->have_posts()) :
                    while ($related_query->have_posts()) : $related_query->the_post();
                        ...
                        $r_terms = get_the_terms(get_the_ID(), 'news_category');
                ...
                <?php endwhile; wp_reset_postdata();
                    ...
                    <p class="sn-side-card__empty">No related articles yet.</p>
                <?php endif; ?>
            </div>
            ...
            <div class="sn-side-cta">
                ...
                <h3>Stay Informed</h3>
                <p>Get the latest news and updates from Apex Softwares.</p>
                <a href="<?php echo esc_url(home_url('/about-us/news')); ?>" class="sn-side-cta__btn">All News &amp; Updates</a>
            </div>
        </aside>
...
<nav class="sn-nav">
    <div class="sn-nav__wrap">
        <?php
        $prev_post = get_previous_post(false, '', 'news_category');
        $next_post = get_next_post(false, '', 'news_category');
