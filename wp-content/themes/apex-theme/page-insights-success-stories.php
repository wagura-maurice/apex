...
apex_render_newsletter_section([
    'form_id'     => 'stories-newsletter-form',
    'heading'     => get_option('apex_stories_newsletter_heading_insights-success-stories', 'Get Success Stories Delivered'),
    'description' => get_option('apex_stories_newsletter_description_insights-success-stories', 'Subscribe to our newsletter for the latest case studies, client success stories, and insights from our team of experts.'),
    'placeholder' => get_option('apex_stories_newsletter_placeholder_insights-success-stories', 'Enter your email address'),
    'button_text' => get_option('apex_stories_newsletter_button_insights-success-stories', 'Subscribe'),
    'note'        => get_option('apex_stories_newsletter_note_insights-success-stories', 'Join 10,000+ subscribers. Unsubscribe at any time.'),
    'source'      => 'Apex Website Success Stories Newsletter Form',
