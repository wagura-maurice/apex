 ...
 * Description: Template for individual about pages
 */
...
<div class="mx-auto max-w-4xl px-4 sm:px-6 lg:px-8 py-12">
    ...
    <div class="mt-12 pt-8 border-t border-apex-gray-200">
        <div class="flex flex-col sm:flex-row gap-4">
            <a href="<?php echo esc_url(home_url('/about-us')); ?>" class="flex-1 inline-flex items-center justify-center rounded-lg border border-apex-orange bg-white px-6 py-3 text-base font-bold text-apex-orange hover:bg-apex-orange hover:text-white transition-all duration-200">
                About Company
            </a>
